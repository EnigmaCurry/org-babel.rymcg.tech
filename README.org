...
This is the host and port the Hugo dev server runs on:
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs.d/rymcg.tech.el :results none
...
(setq rymcg/spellbooks '(("main.org" ("hugo-import-theme"))
                         ("license.org")))
#+END_SRC
...
This section tangles the hugo configuration, templates, styles, and themes:
